class OgcCli < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    ...
    if OS.linux? && Hardware::CPU.intel?
      url "https://github.com/saibit-tech/homebrew-ogc-cli/releases/download/ogc-cli-v0.0.3/ogc_cli-linux_amd64"
      sha256 "30a0a3eb0f3d5ed78b5613ac9b1e26f144821877a91c1cc1d530edfbbfb345c9"
    end

    if OS.linux? && Hardware::CPU.arm?
      url "https://github.com/saibit-tech/homebrew-ogc-cli/releases/download/ogc-cli-v0.0.3/ogc_cli-linux_arm64"
